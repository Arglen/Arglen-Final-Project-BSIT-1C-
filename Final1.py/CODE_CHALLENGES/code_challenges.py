...
def intro_code_challenge():
    while True:
        ...
        print("\t\t\t\t\t=================================================\n")
        print("\t\t\t\t\t|   1. Code Challenge    |   2. Code Challenge  |")
        print("\t\t\t\t\t|   3. Code Challenge    |   4. Code Challenge  |")
        print("\t\t\t\t\t|   5. Code Challenge    |   6. Code Challenge  |")
        print("\t\t\t\t\t|   7. Code Challenge    |   8. Code Challenge  |")
        print("\t\t\t\t\t|   9. Code Challenge    |  10. Code Challenge  |")
        print("\t\t\t\t\t|  11. Code Challenge    |  12. Code Challenge  |")
        print("\t\t\t\t\t|  13. Code Challenge    |  14. Code Challenge  |")
        print("\t\t\t\t\t|  15. Code Challenge    |  16. Code Challenge  |")
        print("\t\t\t\t\t|-----------------------------------------------|")
        print("\t\t\t\t\t|                   0. Return                   |")
        print("\t\t\t\t\t=================================================\n")
